...
export declare class ChatS {
    ...
    static getUsersNotFriends(userId: number, request?: string[], name?: string): Promise<any[]>;
    ...
    static addRequestToUsers(userId: number, usersIn: any): Promise<{}>;
    ...
    static checkUserOwnsContactId(userId: number, contactId: number): Promise<{}>;
}
