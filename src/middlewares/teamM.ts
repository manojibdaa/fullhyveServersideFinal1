...
export class TeamM{
    ...
    public static getTeamMembers(req:any, callback:any){
        ...
        TeamS.getTeamMembers(userId,teamId,offset,limit)
    ...
    public static reply(req:any, callback:any){
        ...
        TeamS.reply(userId, teamId, message, mainAnnouncementId)
    ...
    public static addNewTeam(req:any, callback:any){
        ...
        let teamData = ValidateM.validateNewTeam(userId,req.validData);
    ...
    public static addTeamMember(req:any, callback:any){
        ...
        TeamS.addTeamMember(teamId, memberIds)
