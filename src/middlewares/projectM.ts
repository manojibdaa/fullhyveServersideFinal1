...
export class ProjectM{
    ...
    static getTaskSets(req:any, callback:any){
        ...
        ProjectS.getTaskSets(userId, projectId, offset, limit)
    ...
    static newProject(req:any, callback:any){
        let userId:number = req.thisUser.id;
        let validData = ValidateM.validateNewProject(userId, req.validData);
    ...
    static newSet(req:any, callback:any){
        ...
        ValidateM.validateNewTaskset(validData)

        .then((rTaskset)=>{
            return ProjectS.newSet(userId, rTaskset);
        })
    ...
    static newTask(req:any, callback:any){
        ...
        ValidateM.validateNewTask(validData)

        .then((rTask:any)=>{
            return ProjectS.newTask(rTask);
        })
    ...
    static changeTaskStatus(req:any, callback:any){
        let taskId = req.validData.taskId;
        let rTaskStatus = req.validData.taskStatus;
